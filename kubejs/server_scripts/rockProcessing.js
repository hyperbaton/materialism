ServerEvents.recipes(event => {
    ...
    event.recipes.remove('createsifter:sifting/dirt_string_mesh_waterlogged')
    event.recipes.remove('createsifter:sifting/sand_string_mesh')*/
    event.recipes.remove('createsifter:advanced_brass_mesh_crushed_netherrack_merged')
    event.recipes.remove('createsifter:brass_mesh_crushed_netherrack_merged')
    event.recipes.remove('createsifter:andesite_mesh_sand_merged')
    event.recipes.remove('createsifter:brass_mesh_sand_merged')
    event.recipes.remove('createsifter:andesite_mesh_dust_merged')
    event.recipes.remove('createsifter:brass_mesh_dust_merged')
    event.recipes.remove('createsifter:sturdy_mesh_crushed_end_stone_merged')
    event.recipes.remove('createsifter:advanced_sturdy_mesh_crushed_end_stone_merged')
    event.recipes.remove('createsifter:sturdy_mesh_crushed_basalt_merged')
    event.recipes.remove('createsifter:advanced_sturdy_mesh_crushed_basalt_merged')
    event.recipes.remove('createsifter:andesite_mesh_gravel_merged')
    event.recipes.remove('createsifter:advanced_brass_mesh_gravel_merged')
    event.recipes.remove('createsifter:brass_mesh_gravel_merged')
    event.recipes.remove('createsifter:advanced_brass_mesh_soul_sand_merged')
    event.recipes.remove('createsifter:brass_mesh_soul_sand_merged')
    event.remove(/createsifter.*brass_mesh.*/)
