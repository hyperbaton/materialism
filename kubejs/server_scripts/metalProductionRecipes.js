ServerEvents.recipes(event => {
    ...
    tfcMetals.forEach(metal => 
        event.recipes.tfmg.casting(Fluid.of(`tfc:metal/${metal}`, 100), `tfc:metal/ingot/${metal}`, 100)
    )
    tfcMetallurgyMetals.forEach(metal => 
        event.recipes.tfmg.casting(Fluid.of(`tfc_metallurgy:metal/${metal}`, 100), `tfc_metallurgy:metal/ingot/${metal}`, 100)
    )
    firmalifeMetals.forEach(metal => 
        event.recipes.tfmg.casting(Fluid.of(`firmalife:metal/${metal}`, 100), `firmalife:metal/ingot/${metal}`, 100)
    )
    tfcIron.forEach(metal => 
        event.recipes.tfmg.casting(Fluid.of(`tfc:metal/${metal}`, 100), `tfc:metal/ingot/cast_iron`, 100)
    )
    ...
    function addMetalPartsRecipes(metalName, forgingTemperature, weldingTemperature) {
        ...
        event.recipes.create.sequenced_assembly(
            ...
            TFC.ingredient.heatable(`tfc_metallurgy:metal/ingot/${metalName}`, weldingTemperature, null),
            [
                ...
                event.recipes.create.deploying(`tfc_metallurgy:metal/ingot/${metalName}`, [`tfc_metallurgy:metal/ingot/${metalName}`, TFC.ingredient.heatable(`tfc_metallurgy:metal/ingot/${metalName}`, weldingTemperature, null)]),
                event.recipes.create.pressing(`tfc_metallurgy:metal/ingot/${metalName}`, `tfc_metallurgy:metal/ingot/${metalName}`),
                event.recipes.create.pressing(`tfc_metallurgy:metal/ingot/${metalName}`, `tfc_metallurgy:metal/ingot/${metalName}`)
            ]
        ...
        event.recipes.create.sequenced_assembly(
            ...
            TFC.ingredient.heatable(`tfc_metallurgy:metal/ingot/${metalName}`, forgingTemperature, null),
            [
                event.recipes.create.pressing(`tfc_metallurgy:metal/ingot/${metalName}`, `tfc_metallurgy:metal/ingot/${metalName}`),
                event.recipes.create.pressing(`tfc_metallurgy:metal/ingot/${metalName}`, `tfc_metallurgy:metal/ingot/${metalName}`),
                event.recipes.create.pressing(`tfc_metallurgy:metal/ingot/${metalName}`, `tfc_metallurgy:metal/ingot/${metalName}`),
        ...
        event.recipes.create.sequenced_assembly(
            ...
            TFC.ingredient.heatable(`tfc_metallurgy:metal/sheet/${metalName}`, weldingTemperature, null),
            [
                ...
                event.recipes.create.deploying(`tfc_metallurgy:metal/sheet/${metalName}`, [`tfc_metallurgy:metal/sheet/${metalName}`, TFC.ingredient.heatable(`tfc_metallurgy:metal/sheet/${metalName}`, weldingTemperature, null)]),
                event.recipes.create.pressing(`tfc_metallurgy:metal/sheet/${metalName}`, `tfc_metallurgy:metal/sheet/${metalName}`),
                event.recipes.create.pressing(`tfc_metallurgy:metal/sheet/${metalName}`, `tfc_metallurgy:metal/sheet/${metalName}`)
            ]
        ...
        event.custom({
            ...
            result: {
                item: `tfc_metallurgy:metal/rod/${metalName}`,
                count: 2 
            },
            input: {
                "type": "tfc:heatable",
